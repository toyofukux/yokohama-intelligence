/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/mcp/wrangler.jsonc apps/mcp/worker-configuration.d.ts` (hash: 3d3fdd145760295159fc1eac24135779)
