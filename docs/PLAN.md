...
DRAFT.mdは構想の原文として保持します。本書は今回の費用・市民向け優先度を反映した実行順です。
...
| 7 運用拡大 | 主要50指標・30課題、都市比較、編集体制、更新監視 | DRAFTのv1条件を実測で満たします。編集待ちの滞留・費用増を監視 | 5–6 |

段階ごとの所要時間はデータ形式とレビュー量に依存します。最初の公開βはこの実装で作り、利用調査・日々の継続更新は時間経過と人間の協力を要します。
段階1–4の完成をDRAFT全体のv1完成や市民利用の達成と呼びません。
