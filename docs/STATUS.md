...
更新: 2026-09-06。現在は**人口・世帯の公開β版**です。DRAFTのv1全体と市民利用目標は未達です。
...
外部参照repoは読み取りのみで変更していません。DRAFT.mdも原文のまま。
...
- DRAFT.mdと原資料は原文を保持しています。ローカル作業ディレクトリは既存のワークスペースパスを維持しています。
